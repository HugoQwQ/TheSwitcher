...
loom {
    ...
    forge {
        ...
        mixinConfig("mixins.switcher.json")

    }
    @Suppress("UnstableApiUsage")
    mixin {
        defaultRefmapName.set("mixins.switcher.refmap.json")
    }
}
...
tasks {
    ...
    withType(Jar::class) {
        archiveBaseName.set("TheSwitcher")
        ...
        manifest.attributes.run {
            ...
            this["MixinConfigs"] = "mixins.switcher.json"
        }
    }
    ...
    shadowJar {
        ...
        fun relocateInside(name: String) = relocate(name, "dev.hugouwu.theswitcher.lib.$name")
